			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" style="margin-top:-50px">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password"  name="" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
					...
					<div class="wrap-input100 validate-input"  data-validate = "Password2 is required">
						<input class="input100" type="password"  name="" placeholder="Password2">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-lock" aria-hidden="true"></i>
						</span>
...
export default {
    ...
    methods:{   
        async submjj(){
         ...
         await axios.post("127.0.0.1:8000/api/v1/register/",{
                username: this.user,
